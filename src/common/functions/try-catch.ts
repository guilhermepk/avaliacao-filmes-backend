 ...
 *
 * @throws {HttpException} Se o erro for uma instância de um erro HTTP (erro já tratado).
 * @throws {InternalServerErrorException} Se o erro recebido não for uma instância HTTP (erro não tratado).
 */
function throwError(error: Error, alternativeMessage: string) {
